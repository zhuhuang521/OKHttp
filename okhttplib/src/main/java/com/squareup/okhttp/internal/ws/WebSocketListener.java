...
/** Listener for server-initiated messages on a connected {@link com.squareup.okhttp.internal.ws.WebSocket}. */
public interface WebSocketListener {
   ...
   * com.squareup.okhttp.internal.ws.WebSocket#sendPing(Buffer)} but might also be unsolicited.
   */
  void onPong(Buffer payload);

  /**
   * Called when the server sends a close message. This may have been initiated
   * from a call to {@link com.squareup.okhttp.internal.ws.WebSocket#close(int, String) close()} or as an unprompted
