...
public final class DiskLruCache implements Closeable {
   ...
   * throwing exceptions.
   *
   * <p><strong>The caller must {@link com.squareup.okhttp.internal.DiskLruCache.Snapshot#close close}</strong> each snapshot returned by
   * {@link java.util.Iterator#next}. Failing to do so leaks open files!
   *
   * <p>The returned iterator supports {@link java.util.Iterator#remove}.
   */
