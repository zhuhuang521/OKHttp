...
public final class ConnectionPool {
   ...
   *
   * <p>A {@link java.util.concurrent.ThreadPoolExecutor} is used and not a
  ...
  /**
   * Replace the default {@link java.util.concurrent.Executor} with a different one. Only use in tests.
   */
  // VisibleForTesting
